...
export const PH_BODY =
  'Ett register berättar att ett bolag existerar. Det säger ingenting om det finns ett verkligt skäl att köpa, vem som äger frågan eller varför just nu. Det är den skillnaden Norrsyn arbetar med.';
export const PH_HAND =
  'För att hitta rätt bolag måste vi först definiera vad rätt betyder. Det är där arbetet börjar.';
...
export const COPY = {
  ...
  s5: {
    ...
    foot: 'Förenklad illustration. Varje fynd bedöms som matchar, stärker, osäkert eller väger inte. Bolaget som helhet landar på ett av fyra omdömen, från stark match till ej match. Av 96 djupanalyserade bolag håller 24 hela vägen.',
  },
  s6: {
